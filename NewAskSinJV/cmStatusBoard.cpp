...
//-------------------------------------------------------------------------------------------------------------------------
void cmStatusBoard::config(void Init(uint8_t), void xSwitch(uint8_t,uint8_t)) { //, uint8_t minDelay) {
...
void cmStatusBoard::trigger11(uint8_t setValue, uint8_t *rampTime, uint8_t *duraTime) {
...
/* JVI shorten
void cmStatusBoard::trigger40(uint8_t msgLng, uint8_t msgCnt) {
...
/* JVI shorten
void cmStatusBoard::trigger41(uint8_t msgBLL, uint8_t msgCnt, uint8_t msgVal) {
...
void cmStatusBoard::adjRly(void) {

	// something to do?
	if (( setStat == modStat) && ( ! tr11New ) ) return;															// nothing to do
...
void cmStatusBoard::sendStatus(void) {
...
void cmStatusBoard::rlyPoll(void) {
...
//-------------------------------------------------------------------------------------------------------------------------
void cmStatusBoard::setToggle(void) {
...
void cmStatusBoard::configCngEvent(void) {
...
void cmStatusBoard::pairSetEvent(uint8_t *data, uint8_t len) {
...
void cmStatusBoard::pairStatusReq(void) {
...
void cmStatusBoard::peerMsgEvent(uint8_t type, uint8_t *data, uint8_t len) {
...
//-------------------------------------------------------------------------------------------------------------------------
void cmStatusBoard::regInHM(uint8_t cnl, uint8_t lst, AS *instPtr) {
	hm = instPtr;																			// set pointer to the HM module
	hm->rg.regInAS(cnl, lst, s_mod_dlgt(this,&cmStatusBoard::hmEventCol), (uint8_t*)&lstCnl,(uint8_t*)&lstPeer);
	regCnl = cnl;																			// stores the channel we are responsible fore
}
void cmStatusBoard::hmEventCol(uint8_t by3, uint8_t by10, uint8_t by11, uint8_t *data, uint8_t len) {
...
void cmStatusBoard::peerAddEvent(uint8_t *data, uint8_t len) {
